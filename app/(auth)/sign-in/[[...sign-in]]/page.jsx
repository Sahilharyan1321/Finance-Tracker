    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <a
            className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-white/90 text-amber-600 shadow-md mb-4 hover:scale-105 transition-transform duration-200"
            href="#"
          >
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-2 font-serif">Welcome Back</h1>
          <div className="flex items-center justify-center gap-2">
            <div className="h-px bg-gray-400 w-16" />
            <span className="text-gray-500 font-mono text-sm">EXPENSE TRACKER</span>
            <div className="h-px bg-gray-400 w-16" />
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-xl border border-gray-200">
          ...
          <SignIn 
            appearance={{
              elements: {
                card: "shadow-none p-10 w-full bg-transparent",
        ...
        <p className="text-center mt-6 text-gray-500 font-mono text-xs">
          Secure access • Premium experience
        </p>
      </div>
    </div>
  );
